                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      ...
                      className={`text-xs ${event.status === "confirmed" ? "bg-primary text-primary-foreground" : ""}`}
                    >
                      {event.status === "confirmed" ? "Confirmed" : "Draft"}
                    </Badge>
                  </div>
  ...
  return (
    <div className="space-y-6">
      <div className="grid md:grid-cols-3 gap-3">
        ...
        <div className="flex items-center gap-2.5 px-3 py-2 bg-secondary/30 rounded-lg border border-border/50">
          <div className="flex items-center justify-center w-7 h-7 rounded bg-warning/10">
            ...
            {events.map((event) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Badge
                    variant={event.status === "confirmed" ? "default" : "secondary"}
                    className={event.status === "confirmed" ? "bg-primary text-primary-foreground" : ""}
                  >
                    {event.status === "confirmed" ? "Confirmed" : "Draft"}
                  </Badge>
                </div>
