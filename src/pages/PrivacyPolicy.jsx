        ...
        <div className="bg-gray-900 rounded-lg p-8 border border-gray-800 space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              SoundPath ("we", "our", or "us") is committed to protecting your privacy. This Privacy
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mt-4">
              Your data is stored on secure servers provided by Supabase and other trusted service
              providers. We use encryption in transit and at rest to protect your information.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mt-4">
              ...
              or using the data export/deletion features in your account settings.
            </p>
          </section>
