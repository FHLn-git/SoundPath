...
export interface Event {
  ...
  /** Stage (child org) when venue uses hierarchy; for multi-stage view */
  stageOrganizationId?: string | null
  stageName?: string | null
  /** Festival mode: event blocks multiple stages */
  isMultiStage?: boolean
  /** Stage IDs blocked by this event (when isMultiStage or single stage) */
  linkedStageIds?: string[]
  /** Single stage id (when not festival mode) */
  stageId?: string | null
  /** Phase 0: hold rank; offer link; settlement fields (for DB round-trip) */
  holdRank?: number | null
  holdAutoPromote?: boolean
  offerId?: string | null
  guarantee?: number | null
  doorSplitPct?: number | null
  ticketSalesCount?: number | null
